...
<table border="1" class="table table-dark table-striped">
    ...
    <c:forEach items='${rooms}' var="room">
        <tr>
            ...
            <td>
                <label>
                    <input name="room_name" value="${room.getRoomName()}" disabled>
                </label>
            </td>
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                        <li><a class="dropdown-item"
                               href="${pageContext.request.contextPath}/room?action=update&id=${room.getId()}">Check
                            resident list</a></li>
                        <li><a class="dropdown-item"
                               href="${pageContext.request.contextPath}/room?action=displayAddResidentList&id=${room.getId()}">Add
                            new resident</a></li>
                    </ul>
                </div>
            </td>
